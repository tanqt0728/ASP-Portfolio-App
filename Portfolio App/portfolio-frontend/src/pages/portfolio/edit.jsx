...
const Editor = () => {
    ...
    const handleSave = async () => {
      if (editor && page) {
          ...
          alert('Editor or page data is not loaded properly. Please refresh and try again.');
      }
  };
    ...
    return (
        <div>
            ...
            <div className="App">
                ...
                <button onClick={handleSave} style={{color:"black", marginTop: '10px' }}>Save</button>
                <button onClick={handleShare} style={{ color:"black", marginTop: '10px' }}>Share</button>
                <div id="editor"></div>
            </div>
        </div>
    );
